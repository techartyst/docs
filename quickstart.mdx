...
<CardGroup>
  ...
  <Card title="Personalized experiences" icon="chart-mixed">
Deliver tailored experiences that keep customers coming back.  </Card>

  <Card title="Boost your sales" icon="browser" href="/settings/custom-domain/subdomain">
Expand ways to sell and reach more customers effortlessly.  </Card>
</CardGroup>
